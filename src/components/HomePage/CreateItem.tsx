    ...
    const handleSubmit = async (e:any) => {
        ...
        try {
            const res = await fetch(
                // "https://sheets.googleapis.com/v4/spreadsheets/1nJfe_UGs3KmVkBu9hIDAbi9rA0gnPp4gb8SUjteZplg/values/A1%3AG16?majorDimension=ROWS&valueRenderOption=FORMULA&key=AIzaSyAZgIPp58hO1P6Fps43ADOHuYrHwS9GITg"
