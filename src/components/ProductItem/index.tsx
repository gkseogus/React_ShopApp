  ...
  const deleteData = async () => {
    try {
      const res = await fetch(
        ...
        `https://sheets.googleapis.com/v4/spreadsheets/1nJfe_UGs3KmVkBu9hIDAbi9rA0gnPp4gb8SUjteZplg/values/A%3AG16?majorDimension=ROWS&valueRenderOption=FORMULA&key=AIzaSyAZgIPp58hO1P6Fps43ADOHuYrHwS9GITg/?query=deletefromL7EbjMOJyP3Vr880wherename='${item.name}'`
        //     `https://api.apispreadsheets.com/data/IH9wmldYiWEcOIY8/?query=deletefromIH9wmldYiWEcOIY8wherename='${item.name}'`
        );
